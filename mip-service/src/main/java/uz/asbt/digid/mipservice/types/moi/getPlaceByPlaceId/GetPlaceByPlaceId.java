...
@XmlRootElement(name = "getPlaceByPlaceId")
public class GetPlaceByPlaceId {

    protected Long id;
    @XmlElement(name = "AuthInfo", required = true)
    protected GetPlaceByPlaceId.AuthInfo authInfo;
     ...
     * @return
     *     possible object is
     *     {@link GetPlaceByPlaceId.AuthInfo }
     *
     */
    public GetPlaceByPlaceId.AuthInfo getAuthInfo() {
        return authInfo;
    }
     ...
     *
     */
    public void setAuthInfo(GetPlaceByPlaceId.AuthInfo value) {
        this.authInfo = value;
    }
