...
@XmlRootElement(name = "getPlacesByDistrictId")
public class GetPlacesByDistrictId {

    protected Long id;
    @XmlElement(name = "AuthInfo", required = true)
    protected GetPlacesByDistrictId.AuthInfo authInfo;
     ...
     * @return
     *     possible object is
     *     {@link GetPlacesByDistrictId.AuthInfo }
     *
     */
    public GetPlacesByDistrictId.AuthInfo getAuthInfo() {
        return authInfo;
    }
     ...
     *
     */
    public void setAuthInfo(GetPlacesByDistrictId.AuthInfo value) {
        this.authInfo = value;
    }
