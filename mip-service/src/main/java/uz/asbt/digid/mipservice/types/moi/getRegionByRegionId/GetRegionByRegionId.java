...
@XmlRootElement(name = "getRegionByRegionId")
public class GetRegionByRegionId {

    protected Long id;
    @XmlElement(name = "AuthInfo", required = true)
    protected GetRegionByRegionId.AuthInfo authInfo;
     ...
     * @return
     *     possible object is
     *     {@link GetRegionByRegionId.AuthInfo }
     *
     */
    public GetRegionByRegionId.AuthInfo getAuthInfo() {
        return authInfo;
    }
     ...
     *
     */
    public void setAuthInfo(GetRegionByRegionId.AuthInfo value) {
        this.authInfo = value;
    }
