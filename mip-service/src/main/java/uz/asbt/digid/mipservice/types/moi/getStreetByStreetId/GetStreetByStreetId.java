...
@XmlRootElement(name = "getStreetByStreetId")
public class GetStreetByStreetId {

    protected Long id;
    @XmlElement(name = "AuthInfo", required = true)
    protected GetStreetByStreetId.AuthInfo authInfo;
     ...
     * @return
     *     possible object is
     *     {@link GetStreetByStreetId.AuthInfo }
     *
     */
    public GetStreetByStreetId.AuthInfo getAuthInfo() {
        return authInfo;
    }
     ...
     *
     */
    public void setAuthInfo(GetStreetByStreetId.AuthInfo value) {
        this.authInfo = value;
    }
