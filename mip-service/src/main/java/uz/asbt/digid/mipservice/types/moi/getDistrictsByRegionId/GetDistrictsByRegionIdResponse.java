...
@XmlRootElement(name = "getDistrictsByRegionIdResponse")
public class GetDistrictsByRegionIdResponse {
     ...
     * {@link GetDistrictsByRegionIdResponse.Return }
     *
     *
     */
    ...
    @Override
    public String toString() {
        return "GetDistrictsByRegionIdResponse{" +
                "_return=" + _return +
                '}';
    }
}
