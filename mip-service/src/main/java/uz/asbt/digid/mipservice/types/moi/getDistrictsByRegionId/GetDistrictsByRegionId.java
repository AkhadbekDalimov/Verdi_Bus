...
@XmlRootElement(name = "getDistrictsByRegionId")
public class GetDistrictsByRegionId {

    protected Long id;
    @XmlElement(name = "AuthInfo", required = true)
    protected GetDistrictsByRegionId.AuthInfo authInfo;
     ...
     * @return
     *     possible object is
     *     {@link GetDistrictsByRegionId.AuthInfo }
     *
     */
    public GetDistrictsByRegionId.AuthInfo getAuthInfo() {
        return authInfo;
    }
     ...
     *
     */
    public void setAuthInfo(GetDistrictsByRegionId.AuthInfo value) {
        this.authInfo = value;
    }
