...
@XmlRootElement(name = "getStreetsByPlaceId")
public class GetStreetsByPlaceId {

    protected Long id;
    @XmlElement(name = "AuthInfo", required = true)
    protected GetStreetsByPlaceId.AuthInfo authInfo;
     ...
     * @return
     *     possible object is
     *     {@link GetStreetsByPlaceId.AuthInfo }
     *
     */
    public GetStreetsByPlaceId.AuthInfo getAuthInfo() {
        return authInfo;
    }
     ...
     *
     */
    public void setAuthInfo(GetStreetsByPlaceId.AuthInfo value) {
        this.authInfo = value;
    }
