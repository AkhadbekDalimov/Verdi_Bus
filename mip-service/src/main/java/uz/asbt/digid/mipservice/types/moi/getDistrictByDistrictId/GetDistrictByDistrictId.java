...
@XmlRootElement(name = "getDistrictByDistrictId")
public class GetDistrictByDistrictId {

    protected Long id;
    @XmlElement(name = "AuthInfo", required = true)
    protected GetDistrictByDistrictId.AuthInfo authInfo;
     ...
     * @return
     *     possible object is
     *     {@link GetDistrictByDistrictId.AuthInfo }
     *
     */
    public GetDistrictByDistrictId.AuthInfo getAuthInfo() {
        return authInfo;
    }
     ...
     *
     */
    public void setAuthInfo(GetDistrictByDistrictId.AuthInfo value) {
        this.authInfo = value;
    }
